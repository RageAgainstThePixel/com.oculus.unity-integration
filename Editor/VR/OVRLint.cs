...
public class OVRLint : EditorWindow
{
    ...
    private bool mShowRecordsStaticCommon = false;
    private bool mShowRecordsRuntimeCommon = false;
#if UNITY_ANDROID
    private bool mShowRecordsStaticAndroid = false;
    private bool mShowRecordsRuntimeAndroid = false;
#endif
    ...
    private GUIStyle mFixIncompleteStyle;
    private GUIStyle mFixCompleteStyle;
    ...
    private void DisplayRecords(List<FixRecord> records)
	{
    ...
    private static int FixRecordSorter(FixRecord record1, FixRecord record2)
	{
    ...
    private static void AddFix(eRecordType recordType, string category, string message, FixMethodDelegate method, UnityEngine.Object target, bool editModeRequired, params string[] buttons)
	{
		AddFix(recordType, 0/*sortOrder*/, category, message, method, target, editModeRequired, buttons);
	}

    private static void AddFix(eRecordType recordType, int sortOrder, string category, string message, FixMethodDelegate method, UnityEngine.Object target, bool editModeRequired, params string[] buttons)
	{
...
#pragma warning restore 618
...
#if UNITY_ANDROID
    private static void CheckStaticAndroidIssues()
	{
    ...
    private static void CheckRuntimeAndroidIssues()
	{
    ...
    private enum LightmapType { Realtime = 4, Baked = 2, Mixed = 1 };
