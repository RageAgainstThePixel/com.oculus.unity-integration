...
namespace Facebook.WitAi.Tests
{
    ...
    public class End2EndTests
    {
        ...
        private string pathToNodeExe = @"C:\Program Files\nodejs\node";
        private string pathToTestServerScript = @"C:\open\ovrsource\arvr\assistant\OculusAssistant\TestScripts\voicesdk-testserver.js";
