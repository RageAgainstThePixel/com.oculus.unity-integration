...
public class OVRSkeleton : MonoBehaviour
{
    ...
    protected virtual void InitializeBones()
    {
        ...
        for (int i = 0; i < _bones.Count; ++i)
        {
            ...
            Transform trans = bone.Transform != null
                ? bone.Transform
    ...
    private void InitializeBindPose()
    {
        ...
        for (int i = 0; i < _bindPoses.Count; ++i)
        {
            ...
            Transform trans = bindPoseBone.Transform != null
                ? bindPoseBone.Transform
                : bindPoseBone.Transform = new GameObject(BoneLabelFromBoneId(_skeletonType, bindPoseBone.Id)).transform;
