...
#pragma warning restore 618
    ...
    private const string REMOTE_APK_PATH = "/data/local/tmp";
    private const float USB_TRANSFER_SPEED_THRES = 25.0f;
    private const float USB_3_TRANSFER_SPEED = 32.0f;
    private const float TRANSFER_SPEED_CHECK_THRESHOLD = 4.0f;
    private const int NUM_BUILD_AND_RUN_STEPS = 9;
    private const int BYTES_TO_MEGABYTES = 1048576;

    // Build window variables (not saved)
    private GUIStyle windowStyle;
    private GUIStyle calloutStyle;
    private string currConnectedDevice;
    private Vector2 scrollViewPos;

    // Build window variables (saved)
    private static bool saveKeystorePasswords;
    private static bool isRunOnDevice;
    private static string outputApkPath;

    // Progress bar variables
    private static int totalBuildSteps;
    ...
    private void DisplayAPKPathDialog()
    {
    ...
    private void CancelGradleBuild()
    {
    ...
    private static void ToggleBuildTelemetry()
    {
